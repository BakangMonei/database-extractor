...
export default function StepSettings() {
  ...
  return (
    <div>
      <h2 className="text-2xl font-bold text-gray-900 mb-2">Migration Settings</h2>
      <p className="text-gray-600 mb-6">Configure migration parameters</p>
      ...
      <div className="space-y-6">
        ...
        <div className="border rounded-lg p-6">
          <h3 className="text-lg font-semibold text-gray-900 mb-4">Migration Options</h3>
          <div className="space-y-4">
            ...
            <label className="flex items-center">
              <input
                ...
                className="rounded border-gray-300 text-indigo-600 focus:ring-indigo-500"
              />
              <span className="ml-2 text-sm text-gray-700">Dry run (test without writing data)</span>
            </label>
          </div>
        </div>
      </div>
